...
public class ResumeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws javax.servlet.ServletException, IOException {
        ...
        switch (action) {
            ...
            case "edit":
                r = storage.get(uuid);
                for (SectionType type : new SectionType[]{SectionType.OBJECTIVE, SectionType.PERSONAL}) {
                    StringSection section = (StringSection) r.getSection(type);
                    if (section == null) {
                        r.setSection(type, StringSection.EMPTY);
                    }
                }
                for (SectionType type : new SectionType[]{SectionType.ACHIEVEMENT, SectionType.QUALIFICATION}) {
                    ListSection section = (ListSection) r.getSection(type);
                    if (section == null) {
                ...
                for (SectionType type : new SectionType[]{SectionType.EXPERIENCE, SectionType.EDUCATION}) {
                    ...
                    if (section != null) {
                        for (Organization org : section.getList()) {
